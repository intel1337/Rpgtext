...
void save_score(char *name,  int health, int fear, char* status, int golds, int body) {
...
void load_score(char *name,  int *health, int *fear, char* status, int *golds, int*body) {
